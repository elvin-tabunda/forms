// Function to update print count in the UI and localStorage
...
if (isNaN(printCount)) {
    printCount = 102; // Set default value if printCount is not a number or is null
}
...
document.addEventListener('DOMContentLoaded', function() {
    // Initialize print count
    var printCountInput = document.getElementById("printCountInput");
    printCountInput.value = 'DT' + ('00000' + printCount).slice(-5);
